...
buttons = []
for i in range(8):
    button = tk.Button(root, text = names[i], font=font, bg = "red", height = 6, width = 12)
...
exitButton = tk.Button(root, text = "Zakoncz", command = close, font=font, bg = "red", height = 1, width = 12)
